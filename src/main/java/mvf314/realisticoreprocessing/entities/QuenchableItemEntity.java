...
public class QuenchableItemEntity extends ItemEntity {
	private int counter;
	private ItemStack stack;

	public QuenchableItemEntity(World worldIn, Vec3d pos, ItemStack itemStack, Vec3d vel, int time, Item item) {
